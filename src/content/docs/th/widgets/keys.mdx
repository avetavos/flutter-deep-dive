...
export const quizKeys = [
  ...
  },
  {
    ...
    options: [
      'unique เฉพาะภายใน list เดียว',
      'unique ทั้งแอปและให้เข้าถึง state/context ของ widget จากที่อื่น — ทรงพลังแต่ misuse ง่าย',
      'บังคับ rebuild ทุกเฟรม',
      'เป็น key แบบ default',
    ],
    answer: 1,
  },
];
