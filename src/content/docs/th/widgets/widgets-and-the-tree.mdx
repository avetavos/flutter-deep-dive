...
- **Element** — *living instance* ของ widget ณ ตำแหน่งหนึ่งใน tree element อยู่ต่อเนื่องข้าม rebuild, ถือ `State` ของ stateful widget และตัดสินว่า widget ใหม่จะ update element นี้ได้ หรือต้องสร้างใหม่แทน
...
export const quizTree = [
  {
    ...
    options: [
      ...
      'ด้วย composition — wrap ด้วย widget อีกตัว (เช่น Padding)',
