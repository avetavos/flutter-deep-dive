...
เลิกคิดว่า navigation คือ "การย้ายไปอีกหน้า" ให้คิดว่าเป็น **การแก้ไข stack**: หน้าจอที่คุณเห็นคือ top ของ stack ของ route และทุก `push` กับ `pop` คือ operation บน stack ส่วน declarative routing ก้าวไปอีกขั้น — stack กลายเป็น *ค่าที่ derive มา* จาก app state นั่นคือเหตุผลว่าทำไม deep link และ URL บนเว็บถึงทำงานได้ทันที
</Callout>
